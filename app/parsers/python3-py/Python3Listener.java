...
public interface Python3Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#strr}.
	 * @param ctx the parse tree
	 */
	void enterStrr(Python3Parser.StrrContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#strr}.
	 * @param ctx the parse tree
	 */
	void exitStrr(Python3Parser.StrrContext ctx);
	/**
