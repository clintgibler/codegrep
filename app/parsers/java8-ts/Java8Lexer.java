// Generated from java8-ts/Java8.TypeScriptTarget.g4 by ANTLR 4.7.1
package parsers.java8-ts;
...
public class Java8Lexer extends Lexer {
	...
	public Vocabulary getVocabulary() {
	    ...
	    private static Character_isJavaIdentifierStart: (search_val: number) => boolean = require('App/java_functions/Character_isJavaIdentifierStart.js');
	    private static Character_isJavaIdentifierPart: (search_val: number) => boolean = require('App/java_functions/Character_isJavaIdentifierPart.js');
	    private static Character_toCodePoint: (high: number, low: number) => number = require('App/java_functions/Character_toCodePoint.js')
	...
	@Override
	public String getGrammarFileName() { return "Java8.TypeScriptTarget.g4"; }
	...
	private boolean JavaLetter_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
			return Java8Lexer.Character_isJavaIdentifierStart(this._input.LA(-1));
		case 1:
			return Java8Lexer.Character_isJavaIdentifierStart(Java8Lexer.Character_toCodePoint(this._input.LA(-2), this._input.LA(-1)));
		}
		return true;
	}
	private boolean JavaLetterOrDigit_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 2:
			return Java8Lexer.Character_isJavaIdentifierPart(this._input.LA(-1));
		case 3:
			return Java8Lexer.Character_isJavaIdentifierPart(Java8Lexer.Character_toCodePoint(this._input.LA(-2), this._input.LA(-1)));
		}
		return true;
	}
