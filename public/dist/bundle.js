...
var _user$project$Views_HeaderView$rightSideLinks = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('flex flex-row justify-end'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('link dark-gray ttc'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://github.com/syamp/codegrep'),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Views_HeaderView$headerView = A2(
	_elm_lang$html$Html$header,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('w-100 pa2 bg-light-yellow'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('flex flex-row items-center justify-between'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('flex items-center link dark-gray'),
						_1: {
							ctor: '::',
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$alt('codegrep'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('dib w2 h2 br-100'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$src('dist/logo.svg'),
										_1: {ctor: '[]'}
									}
								}
							},
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('pl2 fw6 code'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('codegrep'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('w-10'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _user$project$Views_HeaderView$rightSideLinks,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Pages_Detail$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Views_HeaderView$headerView,
			_1: {
				ctor: '::',
				_0: function () {
					var _p0 = model.result;
					if (_p0.ctor === 'Just') {
						var _p1 = _p0._0;
						return A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('pa4 bg-washed-yellow'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_0: _elm_lang$html$Html_Attributes$href(
											A2(
												_elm_lang$core$Basics_ops['++'],
												A2(_elm_community$string_extra$String_Extra$leftOf, '.git', _p1.repository),
												A2(_elm_lang$core$Basics_ops['++'], '/tree/master/', _p1.filename))),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href(_p1.repository),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(_p1.repository),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Pages_Detail$initialModel = {result: _elm_lang$core$Maybe$Nothing};
var _user$project$Pages_Detail$highlight = _elm_lang$core$Native_Platform.outgoingPort(
	'highlight',
	function (v) {
		return v;
	});
var _user$project$Pages_Detail$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'NoOp') {
			...
			if (_p3.ctor === 'Ok') {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							result: _elm_lang$core$Maybe$Just(_p4)
						}),
					_1: _user$project$Pages_Detail$highlight(_p4.content)
				};
			} else {
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Pages_Detail$highlight(
						_elm_lang$core$Basics$toString(_p3._0))
				};
			}
		}
	});
var _user$project$Pages_Detail$highlighted = _elm_lang$core$Native_Platform.incomingPort('highlighted', _elm_lang$core$Json_Decode$string);
var _user$project$Pages_Detail$Token = F4(
	function (a, b, c, d) {
		return {text: a, line: b, $char: c, type_: d};
	});
var _user$project$Pages_Detail$tokenDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'text',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Pages_Detail$Token)))));
var _user$project$Pages_Detail$Code = F4(
	function (a, b, c, d) {
		return {content: a, filename: b, repository: c, tokens: d};
	});
var _user$project$Pages_Detail$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'tokens',
	_elm_lang$core$Json_Decode$list(_user$project$Pages_Detail$tokenDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'repository',
		_elm_lang$core$Json_Decode$string,
		A3(
			...
			A3(
				...
				'content',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Pages_Detail$Code)))));
var _user$project$Pages_Detail$Model = function (a) {
	return {result: a};
};
var _user$project$Pages_Detail$DataReceived = function (a) {
	return {ctor: 'DataReceived', _0: a};
};
var _user$project$Pages_Detail$fetch = function (id) {
	var _p5 = id;
	if (_p5.ctor === 'Just') {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Pages_Detail$DataReceived,
			A2(
				_elm_lang$http$Http$get,
				A2(_elm_lang$core$Basics_ops['++'], '/api/document/', _p5._0),
				_user$project$Pages_Detail$decoder));
	} else {
		return _elm_lang$core$Platform_Cmd$none;
	}
};
var _user$project$Pages_Detail$NoOp = {ctor: 'NoOp'};

var _user$project$Pages_Search$resultRow = function (result) {
	return A2(
		...
		},
		{
						...
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$href(
									A2(
										_elm_lang$core$Basics_ops['++'],
										A2(_elm_community$string_extra$String_Extra$leftOf, '.git', result.repository),
										A2(_elm_lang$core$Basics_ops['++'], '/tree/master/', result.filename))),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(result.filename),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(result.repository),
										_1: {ctor: '[]'}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(result.repository),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('code-snippet f6'),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html_Attributes$property,
								'innerHTML',
								_elm_lang$core$Json_Encode$string(result.highlight)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _user$project$Pages_Search$list = function (results) {
	return (!_elm_lang$core$Native_Utils.eq(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('pl0'),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, _user$project$Pages_Search$resultRow, results)),
			_1: {ctor: '[]'}
		}) : A2(
		_elm_lang$html$Html$div,
		{
...
var _user$project$Pages_Search$maybeList = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
...
var _user$project$Pages_Search$searchLanguageOptions = F2(
	function (model, languages) {
		return A2(
			_elm_lang$core$List$map,
			function (x) {
				var _p1 = model.input.language;
				if (_p1.ctor === 'Just') {
					return _elm_lang$core$Native_Utils.eq(_p1._0, x) ? A2(
...
var _user$project$Pages_Search$maybeSearchLanguageOptions = function (model) {
	var _p2 = model.languages;
	switch (_p2.ctor) {
		case 'NotAsked':
			return {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value('any'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
		...
		case 'Success':
			return {
				...
				_1: A2(_user$project$Pages_Search$searchLanguageOptions, model, _p2._0)
			};
		default:
			return {
				ctor: '::',
...
var _user$project$Pages_Search$searchIdentifierOptions = F2(
	function (model, identifiers) {
		return A2(
			_elm_lang$core$List$map,
			function (x) {
				var _p3 = model.input.identifier;
				if (_p3.ctor === 'Just') {
					return _elm_lang$core$Native_Utils.eq(_p3._0, x) ? A2(
						_elm_lang$html$Html$option,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$selected(true),
...
var _user$project$Pages_Search$maybeSearchIdentifierOptions = function (model) {
	var _p4 = model.identifiers;
	switch (_p4.ctor) {
		case 'NotAsked':
			return {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Any Identifier'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			};
		...
		case 'Success':
			...
			if (_p5.ctor === 'Just') {
				return {
					...
					_1: A2(_user$project$Pages_Search$searchIdentifierOptions, model, _p6)
				};
			} else {
				return {
					ctor: '::',
...
var _user$project$Pages_Search$makeSearchAPIUrl = F2(
	function (query, model) {
		return function (url) {
			var _p7 = model.input.repository;
			if (_p7.ctor === 'Nothing') {
				return url;
			} else {
				var _p8 = _p7._0;
				return _elm_lang$core$Native_Utils.eq(_p8, '') ? url : A2(
					_elm_lang$core$Basics_ops['++'],
					url,
					A2(_elm_lang$core$Basics_ops['++'], '&repository=', _p8));
			}
		}(
			function (url) {
				var _p9 = model.input.language;
				if (_p9.ctor === 'Nothing') {
					return url;
				} else {
					var _p10 = _p9._0;
					return _elm_lang$core$Native_Utils.eq(_p10, 'any') ? url : A2(
						_elm_lang$core$Basics_ops['++'],
						url,
						A2(_elm_lang$core$Basics_ops['++'], '&language=', _p10));
				}
			}(
				function (url) {
					...
					if (_p11.ctor === 'Nothing') {
						...
						var _p12 = _p11._0;
						return _elm_lang$core$Native_Utils.eq(_p12, 'any') ? A2(
							_elm_lang$core$Basics_ops['++'],
							url,
	...
	var q1 = function () {
		...
		if (_p13.ctor === 'Just') {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				base,
				A2(_elm_lang$core$Basics_ops['++'], '?query=', _p13._0));
		} else {
			return base;
		}
	}();
	var q2 = function () {
		var _p14 = model.input.language;
		if (_p14.ctor === 'Just') {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				q1,
				A2(_elm_lang$core$Basics_ops['++'], '&language=', _p14._0));
		} else {
			return q1;
		}
	}();
	var q3 = function () {
		var _p15 = model.input.identifier;
		if (_p15.ctor === 'Just') {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				q2,
				A2(_elm_lang$core$Basics_ops['++'], '&identifier=', _p15._0));
		} else {
			return q2;
		}
	}();
	var q4 = function () {
		var _p16 = model.input.repository;
		if (_p16.ctor === 'Just') {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				q3,
				A2(_elm_lang$core$Basics_ops['++'], '&repository=', _p16._0));
		} else {
			return q3;
		}
	}();
...
var _user$project$Pages_Search$initialModel = {
...
var _user$project$Pages_Search$Model = F4(
	function (a, b, c, d) {
		return {results: a, languages: b, identifiers: c, input: d};
	});
var _user$project$Pages_Search$Result = F5(
	function (a, b, c, d, e) {
		return {id: a, filename: b, repository: c, content: d, highlight: e};
	});
var _user$project$Pages_Search$resultDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'highlight',
	_elm_lang$core$Json_Decode$string,
	A3(
...
var _user$project$Pages_Search$ChangeIdentifier = function (a) {
	return {ctor: 'ChangeIdentifier', _0: a};
};
var _user$project$Pages_Search$ChangeLanguage = function (a) {
	return {ctor: 'ChangeLanguage', _0: a};
};
var _user$project$Pages_Search$ChangeSearchInput = function (a) {
	return {ctor: 'ChangeSearchInput', _0: a};
};
var _user$project$Pages_Search$searchInputElem = function (model) {
	var query = function () {
		var _p17 = model.input.query;
		if (_p17.ctor === 'Just') {
			return _p17._0;
		} else {
			return '';
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('input-reset ba b--black-20 pa2 w-100'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('content'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$placeholder('Enter your search terms'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Pages_Search$ChangeSearchInput),
						_1: {
							ctor: '::',
...
var _user$project$Pages_Search$searchView = function (model) {
	var repository = function () {
		var _p18 = model.input.repository;
		if (_p18.ctor === 'Just') {
			return _p18._0;
		} else {
			return '';
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('black-80 pa4 bg-washed-yellow'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Pages_Search$searchInputElem(model),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										_user$project$Pages_Search$maybeSearchLanguageOptions(model)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											_user$project$Pages_Search$maybeSearchIdentifierOptions(model)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('f6 link dim ph3 pv2 mb2 dib white bg-black'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Pages_Search$Search),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Pages_Search$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Pages_Search$searchView(model),
				_1: {
					ctor: '::',
					_0: _user$project$Pages_Search$maybeList(model.results),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Pages_Search$fetchLanguages = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Pages_Search$DataReceivedLanguages,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, '/api/languages', _user$project$Pages_Search$languagesDecoder)));
var _user$project$Pages_Search$DataReceivedResults = function (a) {
	return {ctor: 'DataReceivedResults', _0: a};
};
var _user$project$Pages_Search$fetchResults = function (model) {
	var _p20 = model.input.query;
	if (_p20.ctor === 'Just') {
		return A2(
			_elm_lang$core$Platform_Cmd$map,
			...
			_krisajenkins$remotedata$RemoteData$sendRequest(
				A2(
					_elm_lang$http$Http$get,
					A2(_user$project$Pages_Search$makeSearchAPIUrl, _p20._0, model),
		...
		switch (_p21.ctor) {
			...
			case 'RepositoryInputChanged':
				...
				var newInput = _elm_lang$core$Native_Utils.update(
					input,
					{
						repository: _elm_lang$core$Maybe$Just(_p21._0)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'ChangeSearchInput':
				...
				var newInput = _elm_lang$core$Native_Utils.update(
					input,
					{
						query: _elm_lang$core$Maybe$Just(_p21._0)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'ChangeLanguage':
				...
				var newInput = _elm_lang$core$Native_Utils.update(
					input,
					{
						language: _elm_lang$core$Maybe$Just(_p21._0),
						identifier: _elm_lang$core$Maybe$Just('any')
					});
			...
			case 'ChangeIdentifier':
				...
				var newInput = _elm_lang$core$Native_Utils.update(
					input,
					{
						identifier: _elm_lang$core$Maybe$Just(_p21._0)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				return {ctor: '_Tuple2', _0: _p21._0, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
...
var _user$project$Pages_About$view = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('pa4'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('codegrep is an experimental search engine for code. Currently only a few popular open-source repositories are indexed\n                If you like what you see please star the project on github'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('https://github.com/syamp/codegrep.git'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Pages_About$NoOp = {ctor: 'NoOp'};

var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$initialModel = function (route) {
	return {route: route, searchModel: _user$project$Pages_Search$initialModel, detailModel: _user$project$Pages_Detail$initialModel};
};
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {route: a, searchModel: b, detailModel: c};
	});
...
var _user$project$Main$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_0: A2(
			...
			_user$project$Main$SearchRoute,
			A2(
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Main$DetailRoute,
					A2(
						_evancz$url_parser$UrlParser_ops['<?>'],
						_evancz$url_parser$UrlParser$s('detail'),
						_evancz$url_parser$UrlParser$stringParam('id'))),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
...
var _user$project$Main$parseLocation = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Main$matchers, location);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Main$NotFoundPage = {ctor: 'NotFoundPage'};
var _user$project$Main$AboutPage = {ctor: 'AboutPage'};
var _user$project$Main$DetailPage = function (a) {
	return {ctor: 'DetailPage', _0: a};
};
var _user$project$Main$SearchPage = function (a) {
	return {ctor: 'SearchPage', _0: a};
};
var _user$project$Main$AboutMsg = function (a) {
	return {ctor: 'AboutMsg', _0: a};
};
var _user$project$Main$DetailMsg = function (a) {
	return {ctor: 'DetailMsg', _0: a};
};
var _user$project$Main$SearchMsg = function (a) {
	return {ctor: 'SearchMsg', _0: a};
};
var _user$project$Main$urlUpdated = function (model) {
	var _p1 = model.route;
	switch (_p1.ctor) {
		case 'SearchRoute':
		...
		case 'DetailRoute':
			return {
				...
				_1: A2(
					_elm_lang$core$Platform_Cmd$map,
					_user$project$Main$DetailMsg,
					_user$project$Pages_Detail$fetch(_p1._0))
			};
		case 'AboutRoute':
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		default:
...
var _user$project$Main$init = function (location) {
	...
	var model = _user$project$Main$initialModel(currentRoute);
	return _user$project$Main$urlUpdated(model);
};
	...
	switch (_p3.ctor) {
		case 'SearchRoute':
			return A2(
				...
				_user$project$Pages_Search$view(model.searchModel));
		case 'DetailRoute':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$DetailMsg,
				_user$project$Pages_Detail$view(model.detailModel));
		case 'AboutRoute':
			return A2(_elm_lang$html$Html$map, _user$project$Main$AboutMsg, _user$project$Pages_About$view);
		default:
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'SearchMsg':
				var _p5 = A2(_user$project$Pages_Search$update, _p4._0, model.searchModel);
				var updatedSearchModel = _p5._0;
				var searchCmd = _p5._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'DetailMsg':
				var _p6 = A2(_user$project$Pages_Detail$update, _p4._0, model.detailModel);
				var updatedDetailModel = _p6._0;
				var detailCmd = _p6._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{detailModel: updatedDetailModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$DetailMsg, detailCmd)
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Pages.Search.Msg":{"args":[],"tags":{"ChangeLanguage":["String"],"DataReceivedLanguages":["RemoteData.WebData (List String)"],"RepositoryInputChanged":["String"],"UpdateModel":["Pages.Search.Model"],"DataReceivedIdentifiers":["RemoteData.WebData (List String)"],"ChangeIdentifier":["String"],"DataReceivedResults":["RemoteData.WebData (List Pages.Search.Result)"],"Search":[],"ChangeSearchInput":["String"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Success":["a"],"Loading":[],"Failure":["e"]}},"Pages.About.Msg":{"args":[],"tags":{"NoOp":[]}},"Main.Msg":{"args":[],"tags":{"AboutMsg":["Pages.About.Msg"],"SearchMsg":["Pages.Search.Msg"],"DetailMsg":["Pages.Detail.Msg"],"LocationChanged":["Navigation.Location"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Pages.Detail.Msg":{"args":[],"tags":{"DataReceived":["Result.Result Http.Error Pages.Detail.Code"],"NoOp":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Pages.Search.Result":{"args":[],"type":"{ id : String , filename : String , repository : String , content : String , highlight : String }"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Pages.Detail.Code":{"args":[],"type":"{ content : String , filename : String , repository : String , tokens : List Pages.Detail.Token }"},"Pages.Detail.Token":{"args":[],"type":"{ text : String, line : Int, char : Int, type_ : String }"},"Pages.Search.SearchFormInput":{"args":[],"type":"{ query : Maybe.Maybe String , language : Maybe.Maybe String , identifier : Maybe.Maybe String , repository : Maybe.Maybe String }"},"Pages.Search.Model":{"args":[],"type":"{ results : RemoteData.WebData (List Pages.Search.Result) , languages : RemoteData.WebData (List String) , identifiers : RemoteData.WebData (List String) , input : Pages.Search.SearchFormInput }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
