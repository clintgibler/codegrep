...
var _user$project$Pages_Search$searchLanguageOptions = function (languages) {
	return A2(
		_elm_lang$core$List$map,
		function (x) {
			return A2(
...
var _user$project$Pages_Search$maybeSearchLanguageOptions = function (response) {
	var _p1 = response;
	switch (_p1.ctor) {
		case 'NotAsked':
			return {
		...
		case 'Success':
			return {
				...
				_1: _user$project$Pages_Search$searchLanguageOptions(_p1._0)
			};
		default:
			return {
				ctor: '::',
...
var _user$project$Pages_Search$searchIdentifierOptions = function (identifiers) {
	return A2(
		_elm_lang$core$List$map,
		function (x) {
			return A2(
...
var _user$project$Pages_Search$maybeSearchIdentifierOptions = function (response) {
	var _p2 = response;
	switch (_p2.ctor) {
		case 'NotAsked':
			return {
		...
		case 'Success':
			return {
				...
				_1: _user$project$Pages_Search$searchIdentifierOptions(_p2._0)
			};
		default:
			return {
				ctor: '::',
