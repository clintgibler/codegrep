...
type alias Model =
    { route : Route, searchModel : Search.Model, detailModel : Detail.Model }
...
urlUpdated model =
    case model.route of
        SearchRoute query language identifier repository ->
            let
                ( newModel, cmd ) =
                    Search.init model.searchModel query language identifier repository
            in
...
renderPage model =
    case model.route of
        ...
        DetailRoute id ->
            Detail.view model.detailModel |> Html.map DetailMsg

        AboutRoute ->
            About.view |> Html.map AboutMsg
